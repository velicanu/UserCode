...
void stdsort(int startline = 0, string flist = "", int nmin = 0 , int nmax = 35)
{
  ...
  TFile * outf = new TFile(Form("_sortedHiForest_multbinned_nmin%d_nmax%d_%d.root",nmin,nmax,startline),"recreate");
  c->outf = outf;
  c->GoCrazy();
