...
rootn.exe -b <<EOF
.L /net/hisrv0001/home/dav2105/corrana/makecorrhists/ppbridge/runhf.C+
runcorr($input,$2)
.q
EOF

# echo "before mv"
mv corrhists_trkhfplus_trkqaul* /net/hidsk0001/d00/scratch/dav2105/corrhists/HIData_Minbias_2760GeV/unmerged
