...
{
  if(mccommand>1 && doptweight<2)  doptweight=0;
    ...
    while(true)
    {
      ...
      for(int i = 0 ; i < ntrig ; ++i)
      {
        ...
        for(int j = 0 ; j < nass ; ++j)
        {
          ...
          if(doptweight==2) effweight = effweight*ptw;
