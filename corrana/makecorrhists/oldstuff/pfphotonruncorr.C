#include "/net/hisrv0001/home/dav2105/corrana/makecorrhists/pfphotoncorrana.C"
#include <fstream>

void pfphotonruncorr(int filenum = 0)
{
  ...
  int nlines = 0;
  ifstream infile("/net/hisrv0001/home/dav2105/corrana/makecorrhists/pfphotonsortlist.txt");
  ...
  pfphotoncorrana(listoffiles[filenum].data());
  ...
  TFile * outf = new TFile(Form("pfphotoncorrhists_%d.root",filenum),"recreate");
