#include "/net/hisrv0001/home/dav2105/corrana/makecorrhists/ajcorrana.C"
#include <fstream>

void runajcorr(int filenum = 0)
{
  ...
  int nlines = 0;
  ifstream infile("/net/hisrv0001/home/dav2105/corrana/makecorrhists/tenjetfiles.txt");
  ...
  ajcorrana(listoffiles[filenum].data());
  ...
  TFile * outf = new TFile(Form("jetajcorrhists0_%d.root",filenum),"recreate");
