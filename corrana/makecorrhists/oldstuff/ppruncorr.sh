...
rootn.exe -b <<EOF
.L /net/hisrv0001/home/dav2105/corrana/makecorrhists/ppruncorr.C+
ppruncorr($1)
.q
EOF

# echo "before mv"
mv ppcorrhists_* /net/hidsk0001/d00/scratch/dav2105/corrhists/HIData_Minbias_2760GeV/unmerged
