...
rootn.exe -b <<EOF
.L /net/hisrv0001/home/dav2105/corrana/makecorrhists/frankrun_pf3.C+
mcruncorr($1)
.q
EOF

# echo "before mv"
mv frank_pf3_* /net/hidsk0001/d00/scratch/dav2105/corrhists/HIData_Minbias_2760GeV/unmerged
