...
rootn.exe -b <<EOF
.L /net/hisrv0001/home/dav2105/corrana/makecorrhists/runjetcorr.C+
runjetcorr($1)
.q
EOF

# echo "before mv"
# mv jetcorrhists_* /net/hidsk0001/d00/scratch/dav2105/corrhists/HIData_Minbias_2760GeV/unmerged
